...
class PdfCore extends AbstractGenerator implements ContractsPdfCore {
    /**
     * @var array
     */
    ...
    /**
     * Array with options which require to store the 
     * content of the option before passing it 
     * to wkhtmltopdf.
     *
     * @return $this
     */
